...
func TestGetOperator_WhenNotOp(t *testing.T) {
	wantVal := NOT_OP
...
func TestBoolConstEquals_WhenDiffKinds(t *testing.T) {
...
func TestBoolConstEquals_WhenDiffValues(t *testing.T) {
	boolConst := BuildBoolConst(true)
...
func TestBoolConstEquals_WhenEqual(t *testing.T) {
	boolConst := BuildBoolConst(true)
...
func TestStringConstEquals_WhenDiffKinds(t *testing.T) {
...
func TestStringConstEquals_WhenDiffValues(t *testing.T) {
...
func TestStringConstEquals_WhenEqual(t *testing.T) {
	stringConst := BuildStringConst("Lorem Ipsum")
...
func TestIntConstEquals_WhenDiffKinds(t *testing.T) {
...
func TestIntConstEquals_WhenDiffValues(t *testing.T) {
	intConst := BuildIntConst(0)
...
func TestIntConstEquals_WhenEqual(t *testing.T) {
	intConst := BuildIntConst(0)
	otherConst := BuildIntConst(0)
...
func TestVariableEquals_WhenDiffKinds(t *testing.T) {
...
func TestVariableEquals_WhenDiffValues(t *testing.T) {
...
func TestVariableEquals_WhenEqual(t *testing.T) {
	variable := BuildVariable("test")
...
func TestUnaryOpEquals_WhenDiffKinds(t *testing.T) {
...
func TestUnaryOpEquals_WhenDiffValues(t *testing.T) {
	unaryOp := BuildUnaryOp(notOperator(), BuildBoolConst(true))
...
func TestUnaryOpEquals_WhenEqual(t *testing.T) {
	unaryOp := BuildUnaryOp(notOperator(), BuildBoolConst(true))
...
func TestBinaryOpKind(t *testing.T) {
...
func TestBinaryOpEquals_WhenDiffKinds(t *testing.T) {
...
func TestBinaryOpEquals_WhenDiffValues(t *testing.T) {
...
func TestBinaryOpEquals_WhenEqual(t *testing.T) {
	binaryOp := BuildBinaryOp(BuildIntConst(1), eqOperator(), BuildIntConst(1))
	otherVal := BuildBinaryOp(BuildIntConst(1), eqOperator(), BuildIntConst(1))
...
func TestFunctionCallEquals_WhenDiffKinds(t *testing.T) {
...
func TestFunctionCallEquals_WhenDiffValues(t *testing.T) {
	functionCall := BuildFunctionCall(BuildVariable("foo"), []Expr{})
...
func TestFunctionCallEquals_WhenEqual(t *testing.T) {
	functionCall := BuildFunctionCall(BuildVariable("foo"), []Expr{})
...
func TestArrayEquals_WhenDiffKinds(t *testing.T) {
...
func TestArrayEquals_WhenDiffValues(t *testing.T) {
	array := BuildArray([]Expr{BuildIntConst(1)})
...
func TestArrayEquals_WhenEqual(t *testing.T) {
	array := BuildArray([]Expr{BuildIntConst(1)})
