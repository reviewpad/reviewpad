...
func GetPullRequestLastPushDate(ctx context.Context, client *githubv4.Client, owner string, repo string, number int) (time.Time, error) {
	...
	err := client.Query(ctx, &lastPushQuery, varGQLastPush)
	if err != nil {
